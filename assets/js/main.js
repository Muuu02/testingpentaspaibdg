...
const CONFIG = {
    ...
    GAS_WEB_APP_URL: localStorage.getItem('GAS_WEB_APP_URL') || 'https://script.google.com/macros/s/AKfycbzJKonOBYLUOM_qWKM_qptpVhFWmY9gDVGYYYiZoO9SYG-2qHzzFHg85qwzRLCPE9qe/exec',
    
    // Google Form untuk upload berkas (opsional)
    GOOGLE_FORM_UPLOAD_URL: 'https://forms.gle/YOUR_FORM_ID',
    
    // Site Key reCAPTCHA v3 (untuk form pendaftaran)
    RECAPTCHA_SITE_KEY: '6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI', // Test key
    
    // RSA Public Key (tidak digunakan untuk uji coba, simpan sebagai placeholder)
    RSA_PUBLIC_KEY: null,
...
const LOMBA_DATA = {
    lccp: {
        ...
        mekanisme: ['Babak Penyisihan: Soal lemparan (10) dan rebutan (10)', 'Babak Semifinal: Soal lemparan, rebutan, game, IT, menulis ayat', 'Babak Final: Soal lemparan, rebutan (15), mengurutkan ayat, game, literasi'],
        penilaian: { 'Soal Lemparan': 'Benar +100, Salah 0', 'Soal Rebutan': 'Benar +100, Salah -100', 'Menekan Bel Dini': '-25 poin' },
        waktu: 'Sesuai babak',
        peraturan: ['Peserta wajib membawa gadget dengan kuota internet', 'Jawaban tidak boleh diulang', 'Jeda waktu menjawab maks 10 detik']
    },
    ldc: {
        kode: 'LDC',
        ...
        materi: ['Peduli dan berbagi', 'Menjadi pemimpin yang dicintai', 'Cerdas bergaul sesuai ajaran Islam', 'Mencintai orang tua dan guru', 'Menjaga masa depan dengan mencintai alam', 'Aksi jarimu di media sosial', 'Mencintai Rasulullah', 'Menjaga persatuan', 'Pemuda impian masa depan'],
        mekanisme: ['Tampil berdasarkan nomor undian', 'Menyerahkan teks pidato 3 rangkap', 'Waktu 7-10 menit', 'Tanpa membaca teks'],
        penilaian: { 'Kesesuaian tema & isi': '30', 'Sistematika': '30', 'Penguasaan Materi': '40', 'Gaya bahasa': '30', 'Ekspresi & retorika': '30', 'Ketepatan ayat/Hadits': '30', 'Ketepatan waktu': '10', 'TOTAL': '200' },
        waktu: '7-10 menit',
        peraturan: ['Boleh sisipan bahasa daerah, Arab, atau Inggris', 'Tidak boleh membaca teks', 'Bahasa Indonesia yang baik']
    },
    mtq: {
        kode: 'MTQ',
        ...
        maqro: ['Q.S. Al-Baqarah: 255', 'Q.S. Ali-Imran: 31', 'Q.S. Ali-Imran: 144', 'Q.S. Ar-Rahman: 1', 'Q.S. Al-Kahfi: 1', 'Q.S. Al-Isra: 78'],
        mekanisme: ['Dipanggil sesuai nomor undian', 'Membaca maqro pilihan', 'Minimal 3 lagu, Bayati wajib pembuka dan penutup', 'Waktu maks 8 menit'],
        penilaian: { 'Tajwid': '60', 'Fashahah wal Adab': '40', 'Suara': '40', 'Lagu/Nagmah': '60', 'TOTAL': '200' },
        waktu: 'Maksimal 8 menit',
        peraturan: ['Bayati wajib pembuka dan penutup', 'Minimal 3 lagu', 'Mempertimbangkan kesalahan jali dan khafi']
    },
    mhq: {
        kode: 'MHQ',
        ...
        mekanisme: ['Membaca surat wajib', 'Menyambung 3 ayat', 'Melafalkan 2 surat penuh', 'Menyambung akhir ayat ke surat berikutnya', 'Menyebutkan nama surat dari ayat'],
        penilaian: { 'Tajwid': '50', 'Fashahah wal Adab': '50', 'Tahfidz': '100', 'TOTAL': '200' },
    ...
    lki: {
        ...
        mekanisme: ['Peserta membuat kaligrafi secara bersamaan', 'Kertas A3 disediakan panitia', 'Waktu 240 menit', 'Peserta membawa spidol kecil hitam'],
        penilaian: { 'Ketepatan Kaidah': '100', 'Kebersihan & Keindahan': '10', 'Keserasian Warna & Ornamen': '90', 'TOTAL': '200' },
        waktu: 'Maksimal 4 jam',
        peraturan: ['Variasi ornamen bebas', 'Dilarang menggunakan alat cetak (mal/stempel)', 'Peserta membawa alat tulis sendiri']
    },
    lpsb: {
        kode: 'LPSB',
        ...
        mekanisme: ['Praktik shalat Maghrib berjamaah', 'Dibagi 2 ruangan', 'Penilaian dari Takbiratul Ihram hingga Salam'],
        penilaian: { 'Kesempurnaan bacaan': '100', 'Kesempurnaan gerakan': '100', 'Pakaian': '50', 'TOTAL': '250' },
    ...
    lsqr: {
        ...
        mekanisme: ['Tampil berdasarkan nomor undian', 'Wajib menyanyikan lagu wajib', 'Alat musik: rebana', 'Opening dan closing tidak dinilai'],
        penilaian: { 'Vocal': '350', 'Instrumen': '250', 'Penampilan': '200', 'TOTAL': '800' },
        waktu: 'Sesuai ketentuan',
        peraturan: ['Anggota grup harus homogen gender', '9-11 orang', 'Grup campuran tidak diperbolehkan']
    },
    lpa: {
        kode: 'LPA',
        ...
        mekanisme: ['Hadir 15 menit sebelum acara', 'Dipanggil sesuai nomor undian', 'Nada bebas', 'Waktu maks 8 menit'],
        penilaian: { 'Tajwid & Fashohah': '100', 'Irama & Suara': '100', 'Adab & Kerapihan': '20', 'Doa sesudah adzan': '20', 'TOTAL': '250' },
        waktu: 'Maksimal 8 menit',
        peraturan: ['Pakaian muslim rapi dan sopan', 'Tidak ada pengulangan jika salah', 'Doa sesudah adzan dengan suara keras', 'Khusus putra']
    }
};
...
/**
 * Mask data sensitif (tampilkan beberapa karakter terakhir)
 * @param {string} data 
...
async function loadSystemConfig() {
    try {
        ...
        if (result.success && result.data) {
            ...
            if (result.data.form_pendaftaran !== undefined) CONFIG.FORM_ACTIVE = result.data.form_pendaftaran === 'aktif';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Load config dan tampilkan WA float
